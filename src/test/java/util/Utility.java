...
//	 * Load the URL
//	 */
//	public static Status loadURL(String locator) {
...
//		
//		} catch (Exception e) {
//			status = new Status(false, "Error in loading URL :" + locator + " Details: " + e.getMessage());
//			endTimer();
...
//	 */
//	public static Status waitForTextPresent(String text) {
//
//		Status status = new Status(true);
//
//		try {
...
//			status.setError("Could not find the text '" + text + "' within the implict wait time-out period.");
//		} catch (Exception e) {
//			status.setStatus(false);
//			status.setError("Error while waiting for text-present: '" + text + "' Details: " + e.getMessage());
...
//	 */
//	public static Status fillValue(By fieldSelector, String fieldValue, String fieldName) {
...
//	 */
//	public static Status fillValue(By fieldSelector, String fieldValue, String fieldName, boolean allowException) {
//		Status status = new Status(true);
//		try {
//			startTimer();
...
//				status.setStatus(false);
//				endTimer();
//				status.setError("Error in filling: " + fieldName + ". Details: " + e.getMessage());
...
//	 */
//	public static Status clearElement(By fieldSelector, String fieldName) {
//		Status status = new Status(true);
//		try {
//			startTimer();
...
//			status.setStatus(false);
//			endTimer();
//			status.setError("Error in clearing " + fieldName + ". Details: " + e.getMessage());
...
//	 */
//	public static Status deleteFieldElement(By fieldSelector, String fieldName) {
//		Status status = new Status(true);
//		try {
//			startTimer();
//			fluentWaitForVisibility(fieldSelector);
...
//			status.setStatus(false);
//			endTimer();
//			status.setError("Error in deleting " + fieldName + ". Details: " + e.getMessage());
//			Assert.fail("Error in clearing" + fieldName + ". Details: " + e.getMessage() + "<br></br>Time elapsed- "
//					+ getElapsedTime() + "<br></br>");
//		} catch (Exception e) {
//			status.setStatus(false);
...
//		} catch (NoSuchElementException e) {
//			status.setStatus(false);
//			status.setError("Error while waiting for element: " + element + " attribute: " + attribute
...
//	 */
//	public static Status selectDropdown(By fieldSelector, String fieldValue, String fieldName, boolean allowException) {
//		Status status = new Status(true);
//		try {
//			startTimer();
//			fluentWaitForVisibility(fieldSelector, 5, allowException);
...
//				status.setStatus(false);
//				endTimer();
//				status.setError("Error in selecting the dropdown: " + fieldName + ". Details: " + e.getMessage());
...
//		Status executionStatus = new Status(true);
